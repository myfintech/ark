...
Ark will attempt to convert to the most general type, or produce an
...
* [`flatten`](./flatten.md) is useful for flattening heirarchical data
...
* [`setunion`](./setunion.md) computes the _union_ of multiple
  sets.
