...
YAML is a complex language and it supports a number of possibilities that HCL's 
type system cannot represent. Therefore this YAML decoder
...
- [`jsondecode`](./jsondecode.md) is a similar operation using JSON instead
  of YAML.
- [`yamlencode`](./yamlencode.md) performs the opposite operation, _encoding_
  a value as YAML.
