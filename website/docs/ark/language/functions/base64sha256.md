...
then encoded with Base64 before returning. HCL uses the "standard" Base64
...
* [`filebase64sha256`](./filebase64sha256.md) calculates the same hash from
  the contents of a file rather than from a string value.
* [`sha256`](./sha256.md) calculates the same hash but returns the result
