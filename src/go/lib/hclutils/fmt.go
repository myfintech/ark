...
There is a formatter in the HCL v1 library, but it's incompatible with HCL v2, which is what MANTL uses.
...
of the formatter specific to the tool using it. In the case of MANTL's ark CLI, it only formats BUILD.hcl and
WORKSPACE.hcl files.
*/
