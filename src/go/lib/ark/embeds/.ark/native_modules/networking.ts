import { IngressOptions } from "ark/plugins/@ark/sre/shared";
 ...
 * @example
 *  const i = generateNginxDefaultIngress('console-web', ['pr-3323-console.prod.domain.com'])
 *  // returns
 *  {
 *    name: 'console-web',
 *    rules: [{
 *      host: 'pr-3323-console.eph.domain.dev',
 *      http: {
 *        paths: [{
 *          path: '/',
 *          backend: {
 ...
 * @example
 *  const ingress = generateNginxDefaultIngress('console-web', ['pr-3323-console.prod.domain.com'])
