...
export type VaultServiceAccount = shared.Plugin<Partial<PluginOptions>>
 ...
 * @example
 *  const vaultServiceAccount = VaultServiceAccount({
 *      replicas: "1",
 *  })
 */
declare const plugin: VaultServiceAccount
