...
func TestCheckVersion(t *testing.T) {
	Init(&localVersion) // FIXME: add check for the server before running tests as there is a race condition where the test runs before the server is available; see https://buildkite.com/domain/domain-mono/builds/1897#b0b351b6-2349-45da-88c5-ad4ae4d29c19 for example of race failure
