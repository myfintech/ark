...
replace (
	...
	// TODO: fork repo and publish MANTL controlled copy
	github.com/jaguilar/vt100 => github.com/tonistiigi/vt100 v0.0.0-20190402012908-ad4c4a574305

	// TODO: Use this replacement until a new official version of cobra is published with these changes
	github.com/spf13/cobra => github.com/spf13/cobra v1.0.1-0.20200909172742-8a63648dd905

	// alias for gorm datatypes
	gorm.io/datatypes => github.com/go-gorm/datatypes v1.0.1

	// alias gorm to github
